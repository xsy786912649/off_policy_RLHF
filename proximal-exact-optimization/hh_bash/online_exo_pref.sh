...
bash exp/hh_exp/inference_rm_test.sh 0,1,2,3  models/pythia-2.8b_hh/align_online_exo-pref_nc2/ckpt1 test models/pythia-2.8b_hh/rm eval

bash exp/hh_exp/inference_rm_test.sh 0,1,2,3  models/pythia-2.8b_hh/align_online_exo-pref_nc2/ckpt2 test models/pythia-2.8b_hh/rm eval

bash exp/hh_exp/inference_rm_test.sh 0,1,2,3  models/pythia-2.8b_hh/align_online_exo-pref_nc2/ckpt3 test models/pythia-2.8b_hh/rm eval

bash exp/hh_exp/inference_rm_test.sh 0,1,2,3  models/pythia-2.8b_hh/align_online_exo-pref_nc2/ckpt4 test models/pythia-2.8b_hh/rm eval

bash exp/hh_exp/inference_rm_test.sh 0,1,2,3  models/pythia-2.8b_hh/align_online_exo-pref_nc2/ckpt5 test models/pythia-2.8b_hh/rm eval
