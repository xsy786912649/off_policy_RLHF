...
bash exp/hh_qwen14b_exp/inference_rm_test.sh 0,1,2,3,4,5,6,7  models/qwen2.5-14b_hh/align_dpo-rw_nc2/ckpt1 test models/qwen2.5-14b_hh/rm eval

bash exp/hh_qwen14b_exp/inference_rm_test.sh 0,1,2,3,4,5,6,7  models/qwen2.5-14b_hh/align_dpo-rw_nc2/ckpt2 test models/qwen2.5-14b_hh/rm eval

bash exp/hh_qwen14b_exp/inference_rm_test.sh 0,1,2,3,4,5,6,7  models/qwen2.5-14b_hh/align_dpo-rw_nc2/ckpt3 test models/qwen2.5-14b_hh/rm eval

bash exp/hh_qwen14b_exp/inference_rm_test.sh 0,1,2,3,4,5,6,7  models/qwen2.5-14b_hh/align_dpo-rw_nc2/ckpt4 test models/qwen2.5-14b_hh/rm eval

bash exp/hh_qwen14b_exp/inference_rm_test.sh 0,1,2,3,4,5,6,7  models/qwen2.5-14b_hh/align_dpo-rw_nc2/ckpt5 test models/qwen2.5-14b_hh/rm eval
