"""
Collect all Qwen2.5-14B Anthropic-HH win rate results.
Usage:
    python hh_bash_qwen14b/collect_results.py
"""
import json, os

INFER_BASE = "exp/hh_qwen14b_exp/data/hh_infer_res/models/qwen2.5-14b_hh"
SFT_EVAL   = f"{INFER_BASE}/sft/eval/test.json"
HH_EVAL    = "exp/hh_qwen14b_exp/data/hh/eval/test.json"
...
def main():
    ...
    out = "hh_bash_qwen14b/results.json"
