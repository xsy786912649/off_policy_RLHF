...
def ppr_dpo_loss(ref_logits, 
    ...
    estimated_rewards_prefix = (model_logprobs - ref_logprobs/(1+detla_beta_model)-detla_beta_model*last_logprobs/(1+detla_beta_model)).sum(1, keepdim=True)
