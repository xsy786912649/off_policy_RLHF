"""
Collect all Qwen2.5-3B TLDR win rate results.
...
INFER_BASE = "exp/tldr_qwen3b_exp/data/tldr_infer_res/models/qwen2.5-3b_tldr"
...
def main():
    ...
    out = "tldr_bash_qwen3b/results.json"
