...
print("--------------------")
path1="exp/tldr_qwen7b_exp/data/tldr_infer_res/models/qwen2.5-7b_tldr/sft/eval/test.json"
path11="exp/tldr_exp/data/tldr/eval/test.json"
for i in [1,2,3,4,5]:
    path2="exp/tldr_qwen7b_exp/data/tldr_infer_res/models/qwen2.5-7b_tldr/align_"+loss_type+"_nc2/ckpt"+str(i)+"/eval/test.json"
