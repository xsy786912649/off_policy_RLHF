"""
Collect all Qwen2.5-7B TLDR win rate results.
...
INFER_BASE = "exp/tldr_qwen7b_exp/data/tldr_infer_res/models/qwen2.5-7b_tldr"
...
def main():
    ...
    out = "tldr_bash_qwen7b/results.json"
