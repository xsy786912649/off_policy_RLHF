...
# names and paths
# args: $1=GPUs, $2=model_name, $3=model_path, $4=dataset_path, $5=loss_type, $6=num_contrastive, $7=ref_model_path, $8=online_iter
init_model_name=$2
init_model_path=$3
dataset_name=tldr/rw
dataset_path=$4
# options: pp-dpo-rw/pp-exo-rw
loss_type=$5
num_contrastive=$6
ref_model_path=$7
online_iter=$8
...
# general
#train_bsz * grad_accum * num_gpus = 2 * 8 * 8 = 128
port=1786
train_bsz=2
eval_bsz=4
max_len=650
...
src/align_stage/train_pponline.py \
   --model_name_or_path $init_model_path \
   --ref_name_or_path $ref_model_path \
   --beta_r $beta_r \
   --beta_pi $beta_pi \
   --detla_beta_model $detla_beta_model \
