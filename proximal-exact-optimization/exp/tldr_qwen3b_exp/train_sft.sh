...
init_model_name=$1
init_model_path=$2
dataset_name=tldr/sft
dataset_path=exp/tldr_exp/data/tldr_filtered
tb_path=tb_logs
exp_name=${init_model_name}_tldr/sft
...
# training commands
deepspeed --include localhost:$dev --master_port $port src/sft_stage/train.py \
