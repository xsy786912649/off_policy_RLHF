...
print("--------------------")
path1="exp/hh_qwen3b_exp/data/hh_infer_res/models/qwen2.5-3b_hh/sft/eval/test.json"
path11="exp/hh_qwen3b_exp/data/hh/eval/test.json"
for i in [1,2,3,4,5]:
    path2="exp/hh_qwen3b_exp/data/hh_infer_res/models/qwen2.5-3b_hh/align_"+loss_type+"_nc2/ckpt"+str(i)+"/eval/test.json"
