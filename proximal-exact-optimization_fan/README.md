...
```
Other hyperparameters for training can be specified in `exp/custom_exp/train_sft.sh`. The SFT model will be saved in `/fs-computility/mabasic/zhanghangfan/oss/xsy/proximal-exact-optimization/models/custom-model_custom-data/sft`.
...
MODEL_PATH=/fs-computility/mabasic/zhanghangfan/oss/xsy/proximal-exact-optimization/models/custom-model_custom-data/sft
...
Other hyperparameters for training can be specified in `exp/custom_exp/train_rm.sh`. The SFT model will be saved in `/fs-computility/mabasic/zhanghangfan/oss/xsy/proximal-exact-optimization/models/custom-model_custom-data/rm`.
...
MODEL_PATH=/fs-computility/mabasic/zhanghangfan/oss/xsy/proximal-exact-optimization/models/custom-model_custom-data/rm
