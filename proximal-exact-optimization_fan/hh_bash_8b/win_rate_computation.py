...
print("--------------------")
path1="/fs-computility/mabasic/zhanghangfan/oss/xsy/proximal-exact-optimization/models/llama-8b_hh/sft/eval/test.json"
path11="exp/hh_exp_8b/data/hh/eval/test.json"
for i in [1,2,3,4,5]:
    path2="/fs-computility/mabasic/zhanghangfan/oss/xsy/proximal-exact-optimization/models/llama-8b_hh/align_"+loss_type+"_nc2/ckpt"+str(i)+"/eval/test.json"
